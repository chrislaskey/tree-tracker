...
(function($) {
    var tagit = {
        "addTag": function(tag) {
            ...
            var close = $('<i class="close delete icon"></i>');
                        ...
                        if (keyCode == 13 || keyCode == 9) {
                            if (autocomplete.is(".open")) {
                                ...
                                if (selection.length) {
                                	...
                                	// NOTE: added feature, if nothing is selected by the user
                                	// add the first value on autocomplete list.
                                	var first = $("li", autocomplete).eq(0);
                                	e.tagit("addTag", first.text());
                                    self.val("");
                                }
                            }
